package com.sapling.tools.redis;

import redis.clients.jedis.Jedis;

import static com.sapling.tools.redis.RedisConstants.REDIS_SEPERATOR;
...
public class FrequentCallerChecker {
    ...
    public static boolean checkIsLimited(Jedis jedis, String ip, String apiName, Long periodInMillis, int count) {
        String key = RedisTools.genRedisKey(REDIS_SEPERATOR, REDIS_PRIFIX, ip, apiName);
